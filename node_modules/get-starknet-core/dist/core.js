...
var T = (I, M, e) => (Q(I, typeof M != "symbol" ? M + "" : M, e), e), s = (I, M, e) => {
  if (!M.has(I))
    throw TypeError("Cannot " + e);
};
var j = (I, M, e) => (s(I, M, "read from private field"), e ? e.call(I) : M.get(I)), z = (I, M, e) => {
  if (M.has(I))
    throw TypeError("Cannot add the same private member more than once");
  M instanceof WeakSet ? M.add(I) : M.set(I, e);
}, C = (I, M, e, N) => (s(I, M, "write to private field"), N ? N.call(I, e) : M.set(I, e), e);
var l = (I, M, e) => (s(I, M, "access private method"), e);
const Y = [
  {
    id: "argentX",
    name: "Argent X",
...
class f {
  ...
  set(M) {
    return !j(this, A) && !l(this, a, n).call(this) ? !1 : (this.delete(), this.value = M, M && (C(this, c, `${j(this, u)}-${U()}`), localStorage.setItem(j(this, c), M)), !0);
  }
  get() {
    return l(this, r, S).call(this), this.value;
  }
  delete() {
    return !j(this, A) && !l(this, a, n).call(this) ? !1 : (this.value = null, j(this, c) && localStorage.removeItem(j(this, c)), !0);
  }
}
A = new WeakMap(), c = new WeakMap(), u = new WeakMap(), r = new WeakSet(), S = function() {
  ...
  try {
    !j(this, A) && typeof window < "u" && (C(this, c, Object.keys(localStorage).find(
      (M) => M.startsWith(j(this, u))
    )), C(this, A, !0), j(this, c) && this.set(localStorage.getItem(j(this, c))));
  } catch (M) {
    console.warn(M);
  }
  return j(this, A);
...
function W(I = {}) {
  ...
  return {
    ...
    enable: async (g, i) => {
      if (await g.enable(i), !g.isConnected)
